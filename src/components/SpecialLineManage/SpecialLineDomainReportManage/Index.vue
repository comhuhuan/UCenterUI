...
<script>
    ...
    import { lineDomainReportList,lineDomainReportSelect } from 'api/dxq/specialLineJoinSource'
    ...
    methods: {
        ...
        //下拉框
        selectEvt(){
            lineDomainReportSelect().then(res => {
        ...
        getTableList () {
            ...
            lineDomainReportList(params).then(res => {
