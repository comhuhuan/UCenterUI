    ...
    <el-tabs type="border-card" tab-position="bottom" :activeName="activeName" @tab-remove="tabRemove" @tab-click="tabClick">
        <el-tab-pane label="主页" :closable="false" name="主页">
            ...
            <div id="joinSource">
              <el-form label-width="auto" inline :model="fromFilters" :rules="fromRules" ref="fromFilters">
                ...
                <el-form-item label="IP地址：">
                    <el-input size="mini" v-model="fromFilters.ipAddressQuery"></el-input>
                </el-form-item>
                  <el-form-item>
            ...
            <el-table :data="tableList" border :loading="isLoading" :max-height="tableMaxHeight">
                <el-table-column label="接入域名" prop="secondDomain"></el-table-column>
                <el-table-column label="顶级域名" prop="topDomain"></el-table-column>
                <el-table-column label="IP地址" prop="ipAddress"></el-table-column>
                <el-table-column label="网站名称" prop="webName"></el-table-column>
                <el-table-column label="备案号/许可证号" prop="recordCode"></el-table-column>
                <el-table-column label="域名级别" prop="level"></el-table-column>
                ...
                <el-table-column label="所属机房" prop="serverName"></el-table-column>
        ...
        <el-tab-pane v-for="tab in tabs_list" :key="tab.name" :name="tab.name" closable :label="tab.name">
            <keep-alive>
                <component :is="tab.component" @cancelTab="cancelTab" :tabName="activeName"></component>
            </keep-alive>
        </el-tab-pane>
    </el-tabs>
</template>
...
<script>
    ...
    import { geIpAndDomainList,getIpAndDomainSelect } from 'api/dxq/joinSource'
    ...
    methods: {
        ...
        getTableList () {
            ...
            geIpAndDomainList(params).then(res => {
