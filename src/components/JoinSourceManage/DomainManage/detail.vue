<template>
	<section class="detailPage">
            ...
            <el-table :data="tableList" border :loading="isLoading" :max-height="tableMaxHeight">
                <el-table-column label="IP地址" prop="netIp"></el-table-column>
                <el-table-column label="域名" prop="topDomainIp"></el-table-column>
            </el-table>
...
<script>
    import { DomainManageDetail } from 'api/dxq/joinSource'
	...
	export default {
		...
		methods: {
            getTableList () {
                ...
                DomainManageDetail(params).then(res => {
