	...
	<el-tabs class="tabs-home-page" type="border-card" tab-position="bottom" :activeName="activeName" @tab-remove="removeTabHandle" @tab-click="setActiveTab">
		<el-tab-pane label="主页" :closable="false" name="主页" :loading="initLoading">
			<el-form label-width="auto" inline :model="formFilter" ref="formFilter">
				<el-form-item label="监测名称：" prop="nameQuery">
					<el-input size="mini" placeholder="请输入监测名称" v-model="formFilter.nameQuery" ></el-input>
				</el-form-item>
...
<script>
	...
	import { getInitData, getList, del, send, getOperation } from 'api/gjg/infoMonitoring'
	import Edit from './Edit'
	import Detail from './Detail'
	import EUDetail from './EUDetail'
	import ImportTpl from './ImportTpl'
	import { exportsList } from 'constants/common'
	import { exportDo } from 'api/gjg/infoMonitoring'
	...
	export default {
		...
		data() {
			return {
				...
				columns: [
					{label: '监测ID', prop: 'commandId', hidden: false, },
					{label: '监测名称', prop: 'name', hidden: false, },
					{label: '监测类型', prop: 'groupType', hidden: false, },
					...
					// {label: '信息监测主键', prop: 'idcCommandId hidden: false,', },
