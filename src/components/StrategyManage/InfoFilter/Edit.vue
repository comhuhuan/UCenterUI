                ...
                <fieldset :class="{expand: isBodyExpand, active: isBodyActive}">
                    ...
                    <div class="" v-show="isBodyExpand">
                        <el-form-item label="过滤名称：" prop="name">
                            <el-input size="mini" v-model="bodyFilter.name" placeholder="请输入过滤名称"></el-input>
                        </el-form-item>
                        <el-form-item label="过滤原因：" prop="reason">
                            <el-input size="mini" v-model="bodyFilter.reason" placeholder="请输入过滤原因"></el-input>
                        </el-form-item>
            ...
            <el-form label-width="150px" :model="strategyFilter" ref="strategyFilter" :rules="strategyRules" class="commonForm" :loading="strategyLoading">
                <fieldset :class="{expand: isStrategyExpand, active: !isBodyActive, disabled: !isSaveBody}">
                    ...
                    <div class="" v-show="isStrategyExpand">
                        ...
                        <el-form-item label="过滤种类：" prop="rules"
                            :rules="[
                        ...
                        >
                            ...
                            <el-tooltip effect="dark" content="最多选择6种组合类型，其中源IP和目的IP不能同时勾选，源端口和目的端口不能同时勾选，且源端口或目的端口必须与传输层协议同时选择！" placement="top-start">
                                <el-select size="mini" multiple v-model="strategyFilter.rules" placeholder="请选择过滤种类" :disabled="rulesDiabled">
...
<script>
import { getInitRule, removeRule, save, saveRule, getInitEdit } from 'api/gjg/infoFilter'
